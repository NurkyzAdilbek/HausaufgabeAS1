...
//        Task task5 = new Task("AS",TaskType.STUDIUM,"Hausaufgabe 2", Priority.HOCH, TaskStatus.IN_BEARBEITUNG, LocalDate.of(2026,06,12));
...
//      Task task7 = new Task("SQL",TaskType.STUDIUM,"HA 3", Priority.HOCH, TaskStatus.OFFEN, LocalDate.of(2026,06,10));
//      Task task8 = new Task("IuF",TaskType.STUDIUM,"HA 5", Priority.MITTEL, TaskStatus.FERTIG, LocalDate.of(2026,06,12));
//      Task task9 = new Task("Zahnartzt",TaskType.SONSTIGES,"Zahnreinigung", Priority.HOCH, TaskStatus.OFFEN, LocalDate.of(2026,06,20));
//      Task task10 = new Task("Finanzplanung",TaskType.SONSTIGES,"bei Horbach", Priority.NIEDRIG, TaskStatus.OFFEN, LocalDate.of(2026,06,18));
